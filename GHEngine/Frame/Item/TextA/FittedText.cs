...
public class FittedText : ColoredItem, ITextItem
{
    ...
    // Inherited methods.
    public override void Render(IRenderInfo info)
    {
        ...
        if (IsShadowEnabled)
        {
            ...
            Text,
            DisplayOld.ToRealPosition(Position + (Font.LineSpacing * ShadowOffset)),
            ShadowColor,
            Rotation,
            _originLocation + _finalShadowOffset,
            DisplayOld.ToRealScale(new Vector2(_finalTextSize)),
            Effects,
