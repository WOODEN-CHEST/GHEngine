    ...
    public bool IsMouseOverButton
    {
        get
        {
            if (TestType == ButtonLocationTestType.Area)
            {
                ...
                Vector2 VectorFromCenterToMouse = UserInput._virtualMousePosition.Current - Center;
                Vector2 TransformedMousePosition = UserInput._virtualMousePosition.Current - VectorFromCenterToMouse
            ...
            return Vector2.Distance(UserInput._virtualMousePosition.Current, Position + (TextureSize * 0.5f)
