...
public class JSONFontConverter : JSONAssetDefinitionConverter
{
    ...
    {
        return new GHFontDefinition(assetName, _pathConverter.GetPath(compound.GetVerified<object>(KEY_PATH)));
    }

    public override void WriteDefinition(AssetDefinition definition, JSONCompound compound)
    {
        GHFontDefinition CastDefinition = (GHFontDefinition)definition;
