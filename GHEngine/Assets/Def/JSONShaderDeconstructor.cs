...
public class JSONShaderDeconstructor : JSONAssetDefinitionDeconstructor
{
    ...
    {
        return new GHShaderDefinition(assetName, _pathDeconstructor.GetPath(compound.GetVerified<object>(KEY_PATH)));
    }
}