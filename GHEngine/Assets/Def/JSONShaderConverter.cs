...
public class JSONShaderConverter : JSONAssetDefinitionConverter
{
    ...
    {
        return new GHShaderDefinition(assetName, _pathConverter.GetPath(compound.GetVerified<object>(KEY_PATH)));
    }

    public override void WriteDefinition(AssetDefinition definition, JSONCompound compound)
    {
        GHShaderDefinition CastDefinition = (GHShaderDefinition)definition;
