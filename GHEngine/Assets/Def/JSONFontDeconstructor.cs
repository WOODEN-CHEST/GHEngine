...
public class JSONFontDeconstructor : JSONAssetDefinitionDeconstructor
{
    ...
    {
        return new GHFontDefinition(assetName, _pathDeconstructor.GetPath(compound.GetVerified<object>(KEY_PATH)));
    }
}