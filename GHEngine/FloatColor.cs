...
{
    // Static fields.
    public static FloatColor White => new(1f, 1f, 1f, 1f);
    public static FloatColor Black => new(0f, 0f, 0f, 1f);
    public static FloatColor Transparent => new(0f, 0f, 0f, 0f);
    public static FloatColor Red => new(1f, 0f, 0f, 1f);
    public static FloatColor Green => new(1f, 0f, 0f, 1f);
    public static FloatColor Blue => new(0f, 0f, 1f, 1f);
    public static FloatColor Yellow => new(1f, 1f, 0f, 1f);
    public static FloatColor Magenta => new(1f, 0f, 1f, 1f);
    public static FloatColor Aqua => new(0f, 1f, 1f, 1f);
    ...
    public static FloatColor InvertRGB(FloatColor color)
    {
        return new FloatColor(1f - color.R, 1f - color.G, 1f - color.B, color.A);
    }

    public static FloatColor InvertRGBA(FloatColor color)
    {
        return new FloatColor(1f - color.R, 1f - color.G, 1f - color.B, 1f - color.A);
    }
